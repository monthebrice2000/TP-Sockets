package handling_large_files.pool_based_multi_threaded_design.prodcons.v2;


import handling_large_files.pool_based_multi_threaded_design.prodcons.Message;
...
public class Worker extends Thread{
    ...
    public boolean receiveRequestFile( ) throws IOException {
        ...
        while( ( read = fis.read( buffer ) ) > 0 ){
            sendReplyFile( buffer );
            System.out.println( read );
        }
        //sendReplyFile( "-1".getBytes() );
        System.out.println( "Download Finished");
        //fis.close();
        return false;
    }

    public void sendReplyFile( byte[] buffer ) throws IOException {
